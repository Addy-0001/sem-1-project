...
def termsandcondition():
        ...
        # Change to the next folder
        next_folder = os.path.join(os.getcwd().replace("language_wala","termsandconditions"))
        os.chdir(next_folder)
...
def alert1():
     # Change to the next folder
        next_folder = os.path.join(os.getcwd().replace("language_wala","PrivacyPolicy"))
        os.chdir(next_folder)
...
def Support():
        ...
        # Change to the next folder
        next_folder = os.path.join(os.getcwd().replace("language_wala","support"))
        os.chdir(next_folder)
...
def Contact():
        ...
        # Change to the next folder
        next_folder = os.path.join(os.getcwd().replace("language_wala","contact_us"))
        os.chdir(next_folder)
