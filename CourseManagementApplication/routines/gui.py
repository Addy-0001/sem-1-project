...
canvas.create_window(506, 2006, anchor="nw", window=button_3)
...
canvas.create_window(506, 2036, anchor="nw", window=button_112)
...
canvas.create_window(506, 2066, anchor="nw", window=coursesbtn)
...
canvas.create_window(506, 2096, anchor="nw", window=eventbtn)
...
canvas.create_window(506, 2126, anchor="nw", window=routinebtn)
...
canvas.create_window(740, 2006, anchor="nw", window=termsandcon)
...
canvas.create_window(740, 2036, anchor="nw", window=privacy)
...
canvas.create_window(740, 2066, anchor="nw", window=support)
...
canvas.create_window(740, 2096, anchor="nw", window=contact)
...
canvas.create_window(1010, 2003, anchor="nw", window=cden)
...
canvas.create_window(1010, 2036, anchor="nw", window=ioe)
...
canvas.create_window(1010, 2066, anchor="nw", window=tu)
...
canvas.create_window(1010, 2096, anchor="nw", window=cu)
